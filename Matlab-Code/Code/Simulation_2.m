...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% N1 denotes tatol number of external phase-shifitng steps
% k1 denotes k1-th step of external phase-shifting
% N2 denotes tatol number of internal phase-shifitng steps
...
clc; clear; close all;
f = [1,3];          % fringe frequency
N1=3;               % tatol number of external phase-shifitng steps
N2=12;              % tatol number of internal phase-shifitng steps
